...
\begin{itemize}[<+->]
	...
	\item Die Weierstraßgleichung für diese Punkte vereinfacht sich zu:
	\begin{equation*}
...
\frametitle{\insertsection~--~\insertsubsection}
\begin{lem}
    Gegeben sei eine eine elliptische Kurve $E$, die durch die Lösungen der vereinfachten Weierstraß-Gleichung definiert ist:
    \begin{equation*}
...
\begin{defn} \label{DLP}
    ...
    \begin{equation*}
        x^m = y,
    \end{equation*}
    wird \textbf{Diskretes-Logarithmen-Problem} (kury DLP) genannt.
\end{defn}
\pause
...
\begin{itemize}[<+->]
	...
	\pause
	\textbf{Aber:} Elliptische Kurven besitzen keine ``Primzahlen''\\
\end{itemize}
\end{frame}
...
\begin{itemize}[<+->]
	...
	\pause $\Rightarrow$ Rückschlüsse über Schlüssel mit Seitenkanalangriff möglich.
\end{itemize}
\end{frame}
