...
\begin{thm}
	...
	\end{equation*}
	wobei $\mathbb{F}b=\{\lambda b\mid\lambda\in\mathbb{F}\}$ den von b erzeugten eindimensionale Untervektorraum von $\mathbb{F}^2$ darstellt. Dann ist $(\mathbb{F}^2,\mathcal{G})$ eine affine Ebene.
\end{thm}
\begin{proof}
