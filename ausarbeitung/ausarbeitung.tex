...
\begin{lem}
    ...
    \end{equation}
    Dann gilt: Die Kurve $E$ ist genau dann nicht-singulär ist, wenn das Polynom $f(x) = x^3 + ax + b$ keine mehrfachen Nullstellen besitzt.
\end{lem}
\begin{proof} Wir zeigen die Hin- und Rückrichtung der Aussage.\\
    ...
    Wir schreiben die Weierstraß-Gleichung als Polynom $F(X,Y,Z) = Y^2Z - X^3 - aXZ^2 - bZ^3$, leiten ab und setzen die Ableitungen gleich null:
    \begin{equation*}
        \begin{split}
