...
\end{equation*}
\begin{defn}
	Es sei $V$ ein $n$-dimensionaler Vektorraum, $U$ ein beliebiger $(n-1)$-dimensionaler Untervektorraum von $V$ und $v\in V$ beliebig. Eine Teilmenge $H\subset V$ nennt man \textbf{Hyperebene} von $V$, wenn gilt:
\begin{equation*}
...
Jede lineare Hyperebene lässt sich als Lösungsmenge einer homogenen linearen Gleichung beschreiben.\cite[Seite~189]{linalg}
Dies lässt eine alternative Definition unserer Geradenmenge zu, die uns oft nützlich sein wird. \\
...
\begin{proof}
	...
	Es sei nun $G\in\mathcal{G}$ mit $P,Q\in G$ und $\overline{P,Q}\ne G$.
	Dann folgt, dass der von $P$ und $Q$ aufgespannte Unterraum $\langle P,Q\rangle$ eine Teilmenge von $G$ sein muss, also $\overline{P,Q}\subseteq G$. Allerdings gilt, dass jede Gerade in $\mathcal{G}$ die Dimension zwei besitzt, also $\overline{P,Q}=G$. \\
