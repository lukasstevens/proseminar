...
Es sei $\mathbb{F}$ ein beliebiger Körper mit neutralem Element $0$ und $\mathbb{F}^3$ der dreidimensionale Vektorraum über $\mathbb{F}$ mit Nullvektor $\boldsymbol 0:=(0,0,0)$. Wir definieren eine Äquivalenzrelation~``$\sim$'' für alle $a,b\in\ftnz$ wie folgt:\\
\begin{equation*}
	a\sim b :\Leftrightarrow \exists\lambda\in\fnz:\lambda*a=b
\end{equation*}
Für die Äquivalenzklassen von $a=(a_1,a_2,a_3)\in\ftnz$ schreiben wir $[a]$ und $(a_1:a_2:a_3)$.
