...
\begin{equation*}
	\overline{P,Q}\coloneqq\bigl \{[\lambda a+\mu b]\mid\lambda,\mu\in\fnz\bigr \}
\end{equation*}
...
Für $P \in U$ gilt $P = (u:v:0)$ mit $u,v \in \mathbb{F}$. Es gibt drei Möglichkeiten Punkte zu erzeugen, die 0 als Z-Koordinate haben: $P = (1:0:0)$, $Q = (u:v:0)$ mit $u,v \in \mathbb{F} \setminus \{0\}$ und $\mathcal{O} = (0:1:0)$. 
