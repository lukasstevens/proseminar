...
\end{thm}
\begin{proof}
	Die Beweisidee basiert darauf, dass man einen Vektor n wählt, der orthogonal zu H ist. Jeder Vektor, der in H liegt, muss also orthogonal zu n sein. Für den genauen Beweis verweisen wir hier auf\cite[Seite~189]{linalg}.
\end{proof}
