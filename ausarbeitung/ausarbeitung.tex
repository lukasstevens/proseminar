...
\begin{bsp}
Das \textbf{Minimalmodell} einer affinen Ebene umfasst genau 4 Punkte. TODO Beweisreferenz
\begin{center}
\begin{tikzpicture}[node distance=2.5cm,main node/.style={circle,fill=black,draw}]

\node at (0,0) [main node] (A) [label={[label]180:$a$}] {}; 
\node at (1.25,-2.5) [main node] (B) [label={[label]180:$b$}] {}; 
\node at (2.5,0)[main node] (C) [label={[label]0:$c$}] {};
\node at (1.25,-0.8) [main node] (D) [label={[label]0:$d$}] {};
