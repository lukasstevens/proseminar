...
Für einen Vektor $a\in\ftnz$ stellt $[a]\cup\{\boldsymbol 0\}$ also gerade den eindimensionalen Untervektorraum $\mathbb{F}a$ dar.\\
...
Man beachte, dass die Bedingung $P\ne Q$ gleichbedeutend ist mit der linearen Unabhängigkeit der Vektoren $a,b\in\mathbb{F}^3$. Für zwei Punkte $P,Q\in\mathcal{P}$ stellt $\overline{P,Q}\cup\{\boldsymbol 0\}$ also gerade den zweidimensionalen Untervektorraum $\mathbb{F}a+\mathbb{F}b$ dar. 
Die Menge der Punkte einer Geraden $\overline{P,Q}$ entsprechen also der Menge der eindimensionalen Untervektorräume, die jeweils als Teilmenge in $\mathbb{F}a+\mathbb{F}b$ enthalten sind. Formell ausgedückt:
\begin{equation*}
	[c]\in\overline{[a],[b]}\Leftrightarrow \mathbb{F}c\subseteq\mathbb{F}a+\mathbb{F}b		
\end{equation*}
Schlussendlich bilden wir noch die Menge aller Geraden:
\begin{equation*}
...
\begin{proof}
	...
	(P1) Die Existenz folgt direkt aus der Definition unserer Menge $\mathcal{G}$. Die Eindeutigkeit folgt aus (P2).\\
	(P2) Es sei $P,Q\in\mathcal{G}$ mit $P\ne Q$.
\end{proof}
