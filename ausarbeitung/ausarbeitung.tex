...
\begin{defn} \label{DLP}
    ...
    \begin{equation*}
        x^m = y,
    \end{equation*}
    wird Diskretes-Logarithmen-Problem (kurz DLP) genannt. In der Kryptologie betrachten wir dabei meist endliche Gruppen.
\end{defn}
...
\end{enumerate}
Dabei kann ein Angreifer den Klartext $\mathcal{P}$ nicht effizient berechnen, da er dafür das Diskrete-Logarithmen-Problem iuf elliptischen Kurven lösen müsste. \\
\newline
