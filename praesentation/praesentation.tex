...
\begin{frame}
    \frametitle{Grafische Darstellungen}
    \begin{figure}[H]
        \centering
...
\begin{frame}
    \frametitle{Grafische Darstellung}
    Und wie sieht das Ganze über endliche Körper aus?\\
    (siehe addition.gif)\\
    \pause
    Quelle: \url{http://arstechnica.com/}
\end{frame}
...
\begin{frame}
    ...
    \vfill
    \pause
    \center{\small{Elliptische Kurven sind einfach super.}}
\end{frame}
