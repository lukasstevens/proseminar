...
\begin{equation*}
	\overline{P,Q}\coloneqq\bigl \{[\lambda a+\mu b]\mid a,b\in\ftnz \land (0,0)\ne(\lambda,\mu)\in\mathbb{F}\bigr \}
\end{equation*}
Mit $\lambda=1$ und $\mu=0$ bzw.\ $\lambda=0$ und $\mu=1$ folgt direkt $P,Q\in\overline{P,Q}$.\\

Nun können wir auch die Menge aller Geraden bilden:
\begin{equation*}
	\mathcal{G}\coloneqq\{\overline{P,Q}\mid P,Q\in\mathcal{P}\land P\ne Q\}
\end{equation*}
Das Tupel $(\mathcal{P},\mathcal{G})$ beschreibt ein sogenanntes \textbf{homogenes Modell} und bildet eine projektive Ebene. Dies wollen wir im Folgenden beweisen.
